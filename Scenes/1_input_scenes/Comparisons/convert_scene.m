folder_name = "8_agents/implicit_crowds/8_agents_output/output_8_agents_sym/debug/";

fileID = fopen(folder_name+"agent0.txt",'r');
A = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent1.txt','r');
B = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent2.txt','r');
C = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent3.txt','r');
D = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent4.txt','r');
E = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent5.txt','r');
F = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent6.txt','r');
G = fscanf(fileID,'%f');
fileID = fopen(folder_name+'agent7.txt','r');
H = fscanf(fileID,'%f');
