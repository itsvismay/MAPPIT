...
%     num_segments = 100; max_iters = 2; num_inside_iters = 20; mu_barrier= 1; smoothing_eps_coeff = 1e-2;
%  fname = "../Scenes/1_input_scenes/battlefield/102Agents/";nLayer = 3; bypass_mind_edge = 1;
%      num_segments = 20; max_iters = 3; num_inside_iters = 100; mu_barrier= 1; smoothing_eps_coeff = 1e-2;
